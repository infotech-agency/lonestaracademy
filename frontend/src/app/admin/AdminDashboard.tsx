...
//       fd.append("slug", courseForm.slug.trim()); // ✅ Added Slug
...
//     {key:"admissions",label:"Admissions", icon:Settings}
//   ] as const;
...
//                 <button className="rounded-full border border-emerald-200 bg-emerald-50 px-4 py-1.5 text-sm font-medium text-emerald-700">Admissions</button>
//               </div>
//             </div>
...
//                       <div>
//                         <label className="mb-1.5 block text-sm font-semibold text-slate-700">Custom Slug (Optional)</label>
//                         <input 
...
//                           Auto-generated: <span className="font-mono text-blue-600">{courseForm.name ? `${slugify(courseForm.name)}-course-delhi` : "..."}</span>
//                         </p>
//                       </div>
