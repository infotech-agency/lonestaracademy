...
// //             <BookOpen size={60} className="mx-auto mb-4 text-slate-300" />
// //             <h2 className="text-2xl font-bold text-slate-800">
// //               Course not found
// //             </h2>
// //             <a href="/courses" className="mt-4 inline-block text-blue-600">
// //               Browse all courses
// //             </a>
// //           </div>
// //         </div>
...
//         {/* Mobile Floating Action Button for Enquiry Form */}
//         <div className="fixed bottom-6 right-4 z-50 md:hidden">
//           <button
//             onClick={() => setShowMobileForm(true)}
//             className="flex items-center gap-2 rounded-full bg-orange-600 px-5 py-3 shadow-lg transition hover:bg-orange-700 hover:scale-105"
//           >
//             <Info size={20} className="text-white" />
//             <span className="font-semibold text-white">Enquiry</span>
//           </button>
//         </div>
