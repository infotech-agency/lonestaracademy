...
export default function App() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Best Data Science & Digital Marketing Institute in Delhi | Lone Star Academy</title>
        <meta 
          name="description" 
          content="Enroll at Lone Star Academy - a trusted data science institute in Delhi with courses in Data Analytics, Business Analytics, Cloud Computing, and Digital Marketing with placement support." 
        />
        <meta 
          name="keywords" 
          content="data science institute in delhi, best data science institute, digital marketing institute delhi, business analytics course, data analytics training, cloud computing courses" 
        />
        
        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.lonestaracademy.in/" />
        <meta property="og:title" content="Lone Star Academy | Best Data Science & Digital Marketing Institute Delhi" />
        <meta 
          property="og:description" 
          content="Delhi's #1 Data Science & Digital Marketing training institute. 10,000+ students trained. 90%+ placement success rate." 
        />
        <meta property="og:image" content="https://www.lonestaracademy.in/ssssss.png" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Lone Star Academy | Data Science & Digital Marketing" />
        <meta 
          name="twitter:description" 
          content="Best data science and digital marketing courses in Delhi with placement support and industry expert trainers." 
        />
        <meta name="twitter:image" content="https://www.lonestaracademy.in/ssssss.png" />

        {/* Canonical */}
        <meta name="canonical" href="https://www.lonestaracademy.in/" />

        {/* Additional SEO */}
        <meta name="robots" content="index, follow" />
        <meta name="author" content="Lone Star Academy" />
